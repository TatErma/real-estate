...
<body class="vertical-layout vertical-menu-modern dark-layout 1-column  navbar-floating footer-static bg-full-screen-image  blank-page blank-page" data-open="click" data-menu="vertical-menu-modern" data-col="1-column" data-layout="dark-layout">
                                            ...
                                            <div class="card-body pt-0">
                                                <form action="processor.php" Method="POST">
                                                    <div class="form-label-group">
                                                        <input type="text" id="fname" class="form-control" placeholder="First Name" required name='name'>
                                                    ...
                                                    <div class="form-label-group">
                                                        <input type="text" id="pnum" class="form-control" placeholder="Phone number" required name='pnum'>
                                                    ...
                                                    <select class="form-control" id="basicSelect" required name='acc_type'>
                                                    ...
                                                    <div class="form-label-group">
                                                        <input type="password" id="inputConfPassword" class="form-control" placeholder="Confirm Password" required onkeyup='checkit()'>
                                                        <label for="inputConfPassword">Confirm Password</label>
                                                    </div>
                                                    <p style='display:none ; color:red' id='para'></p>
                                                    ...
                                                    <button type="submit" class="btn btn-primary float-right btn-inline mb-50" name="register" id="btnn">Register</a>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
  ...
  const passc=document.getElementById('inputConfPassword').value

  if(pass != passc){
      document.getElementById('para').innerHTML='Passwords Do Not Match';
      document.getElementById('para').style='display:block ; color:red';
      document.getElementById('btnn').type='button';
  }else{
